...
public class PassengerGeneratorImpl implements PassengerGenerator {
    private static final Logger LOGGER = Logger.getLogger(PassengerGeneratorImpl.class);
    ...
    public PassengerGeneratorImpl(AbstractRealDistribution dayDistribution, Random random, Utils utils) {
        super();
