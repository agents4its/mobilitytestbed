...
public class PassengerDecentrLogicExample extends PassengerDecentrLogic {
	...
	public PassengerDecentrLogicExample(String agentId, RequestConsumerMessageProtocol sender,
	...
	public void processRejection(RequestReject r) {
		...
		if (!driversThatRejectedMe.contains(r.rejectReceivedFrom))
			driversThatRejectedMe.add(r.rejectReceivedFrom);
