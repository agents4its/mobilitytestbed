 ...
 * @author Lukas Canda
 */
public abstract class PassengerDecentrLogic extends PassengerLogic<RequestConsumerMessageProtocol> {

	public PassengerDecentrLogic(String agentId, RequestConsumerMessageProtocol sender,
