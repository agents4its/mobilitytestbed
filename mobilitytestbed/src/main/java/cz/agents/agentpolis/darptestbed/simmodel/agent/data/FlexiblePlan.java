...
public class FlexiblePlan implements Cloneable {
	 ...
	 * 
	 * @param node
	 *            node that will become the first node of the plan
	...
	// if (!item.getIn && item.getPassengerId().equals(passengerId)) {
	// this.removeItem(i);
	// return true;
	// }
	// }
