...
public abstract class DriverDecentralizedLogic extends DriverLogicWithPassengerMessageProtocol {
     ...
     *
     * @param proposal proposal to be send (it contains also the id of the passenger)
     */
     ...
     *
     * @param proposal the proposal that's been accepted
     ...
     *
     * @param proposal the proposal that's been rejected
     */
     ...
     *
     * @param proposals proposals to be trasferred
     * @return requests
     */
     ...
     *
     * @param reqsToSearch the requests we're looking for
     * @param plan         the plan we're searching in
     ...
     * using this message.
     *
     * @param requests requests with passengers to be confirmed
     */
