...
public class TestbedMain {
	...
	public static void main(String[] args) throws MalformedURLException, ConfigReaderException {
		...
		File experiment = new File(args[0]);
		...
		int numOfPassenger = scenario.getIntegerValueFromConfig("numOfPassenger");
		int numOfDriver = scenario.getIntegerValueFromConfig("numOfDriver");
