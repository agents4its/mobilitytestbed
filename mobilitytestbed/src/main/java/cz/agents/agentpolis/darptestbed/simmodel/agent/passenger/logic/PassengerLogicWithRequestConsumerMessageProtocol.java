...
public abstract class PassengerLogicWithRequestConsumerMessageProtocol extends
    ...
    public PassengerLogicWithRequestConsumerMessageProtocol(String agentId, RequestConsumerMessageProtocol sender, DriverMessageProtocol driverCentrMessageProtocol, TestbedModel taxiModel, AgentPositionQuery positionQuery, Utils utils, PassengerProfile passengerProfile, TestbedPassengerActivity passengerActivity, TimeSpendingActivity timeSpendingActivity, RequestLogger logger) {
        super(agentId, sender, driverCentrMessageProtocol, taxiModel, positionQuery, utils, passengerProfile, passengerActivity, timeSpendingActivity, logger);
    }
