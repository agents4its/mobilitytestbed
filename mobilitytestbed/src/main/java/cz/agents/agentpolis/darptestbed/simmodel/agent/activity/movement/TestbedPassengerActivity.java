...
public class TestbedPassengerActivity implements LinkedEntitySensor {
     ...
     *
     * @param passengerId    the passenger who wants to travel
     * @param vehicleId      the vehicle he's going to travel with
     * @param targetPosition the number of his target node
     */
    public void useArrivedVehicle(String passengerId, String vehicleId, long targetPosition) {
        ...
        checkArgument(useVehicleAction.getInVehicle(passengerId, vehicleId, this.emptyCallback, this),
                "The passenger " + passengerId + " is not able to get into the vehicle with id " + vehicleId
                        + ", because the vehicle has no free seats. " + taxiModel.getNumOfPassenOnBoard(vehicleId));
        // log the event
     ...
     * @param vehicleId                 the vehicle he's going to travel with
     * @param targetPosition            the number of his target node
     * @param passengerActivityCallback callback to be called after reaching my target node
     */
    public void useArrivedVehicle(String passengerId, String vehicleId, long targetPosition,
     ...
     *
     * @param unlinkedFromEntityId the vehicle he's gotten unlinked from
     */
    @Override
